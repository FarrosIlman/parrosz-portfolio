...
const App = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (height > 0) {
        const scrolledPerc = (winScroll / height) * 100;
        setScrollProgress(scrolledPerc);
      }
    };
  ...
  const projects = [
    { id: "01", tag: "FLAGSHIP IMPLEMENTATION", title: "HOS-Pass: Smart Attendance", category: "Android Native Engineering", image: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?auto=format&fit=crop&q=80&w=800", desc: "Sistem otomasi presensi biometrik untuk SMA Negeri 4 Pekalongan menggunakan Face Recognition dan Geofencing secara real-time.", features: ["Face Recognition", "Geofencing", "Java Native"], color: "from-blue-600 to-indigo-600" },
    { id: "02", tag: "SYSTEM ARCHITECTURE", title: "Integrated School SIS (Sisfo)", category: "Web & Database Management", image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=800", desc: "Pengembangan sistem informasi sekolah yang mengelola data akademik secara terpusat dengan optimasi database untuk efisiensi administrasi.", features: ["Database Optimization", "Automated Reporting", "Web SIS"], color: "from-slate-600 to-slate-800" },
    { id: "03", tag: "SECURITY & INTEGRITY", title: "Secured CBT System (Exampel)", category: "Software Security Development", image: "https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&q=80&w=800", desc: "Pengembangan sistem ujian berbasis komputer (CBT) dengan proteksi tingkat lanjut untuk menjaga integritas akademik siswa.", features: ["Anti-Cheat Logic", "Session Lockdown", "Data Integrity"], color: "from-cyan-600 to-blue-600" },
    { id: "04", tag: "RESEARCH COLLABORATION", title: "Stunting Monitoring System", category: "Web Engineering", image: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&q=80&w=800", desc: "Platform monitoring data tumbuh kembang anak untuk deteksi dini stunting berkolaborasi dengan tim riset dosen.", features: ["Data Tracking", "UI/UX Research", "Public Health"], color: "from-rose-600 to-orange-600" }
  ];
      ...
      <div className="min-h-screen bg-slate-50 dark:bg-[#121212] text-slate-900 dark:text-[#e2e8f0] font-sans selection:bg-blue-500/30 overflow-x-hidden transition-colors duration-500">
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="grid lg:grid-cols-12 gap-8 md:gap-12 items-center">
              <div className="lg:col-span-8 order-2 lg:order-1 text-left">
                <div className="inline-flex items-center gap-3 mb-4 md:mb-8 animate-fade-in text-blue-600 dark:text-blue-400">
                  <span className="w-6 md:w-8 h-px bg-current"></span>
                  <span className="text-[8px] md:text-[10px] uppercase tracking-[0.4em] font-bold">Digital Architect & Specialist</span>
                </div>
              ...
              <div className="lg:col-span-4 order-1 lg:order-2 flex justify-center lg:justify-end animate-fade-in mb-6 md:mb-0">
                <div className="relative">
                  ...
                  <div className="relative w-44 h-44 md:w-64 md:h-64 group text-left">
                    <div className={`w-full h-full overflow-hidden transition-all duration-[2000ms] cubic-bezier(0.4, 0, 0.2, 1) rounded-[40%_60%_70%_30%/40%_50%_60%_40%] group-hover:rounded-[60%_40%_30%_70%/60%_30%_70%_40%] border-2 border-white/10 dark:border-white/5 shadow-2xl`}>
                      <img src="/me.webp" alt="Farros Profil" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-1000 scale-110 group-hover:scale-100" />
                    </div>
                    <div className="absolute bottom-2 right-2 md:bottom-4 md:right-4 bg-white/90 dark:bg-[#1a1a1a]/90 backdrop-blur-md p-2 md:p-3 rounded-2xl border border-black/5 dark:border-white/10 shadow-xl flex items-center gap-2 animate-bounce">
                      ...
                      <span className="text-[7px] md:text-[9px] font-bold uppercase tracking-widest text-slate-500 dark:text-slate-300 text-nowrap">Available Now</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section id="work" className="py-12 md:py-24 border-t border-black/5 dark:border-white/5">
          <div className="container mx-auto px-6 md:px-16 max-w-6xl">
            <div className="flex items-baseline justify-between mb-10 md:mb-24 text-left">
        ...
        <section id="about" className="py-12 md:py-24 bg-slate-100 dark:bg-[#1a1a1a] border-y border-black/5 dark:border-white/5 relative">
          <div className="container mx-auto px-6 md:px-16 relative z-10 max-w-6xl text-left">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
              ...
              {/* TECHNICAL EXPERTISE WITH GLASSMORPHISM */}
              <div className="lg:col-span-5 lg:sticky lg:top-32 h-fit text-left">
                <div className="bg-white/80 dark:bg-[#222222]/80 backdrop-blur-2xl p-8 md:p-10 rounded-[2.5rem] border border-black/5 dark:border-white/10 shadow-2xl transition-all duration-700">
                  <h3 className="text-[10px] font-bold uppercase tracking-[0.4em] text-blue-600 mb-8 md:mb-10 text-left">Technical Expertise</h3>
                  <div className="space-y-8">
                    <SkillBlock title="Development" skills={['Kotlin', 'React', 'Laravel', 'CodeIgniter', 'Java Native', 'PHP']} />
                    <SkillBlock title="Tools & DB" skills={['Firebase', 'MySQL', 'PostgreSQL', 'Git', 'Android Studio', 'VS Code']} />
                  </div>
                </div>
              </div>
            </div>
        ...
        <section id="contact" className="py-16 md:py-40 text-center px-6">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6 sm:gap-16 text-sm md:text-xl font-light">
            <a href="mailto:rosilman000@gmail.com" className="border-b border-black/20 dark:border-white/20 hover:border-blue-500 transition-all pb-2 dark:text-white tracking-widest text-nowrap">Email Me</a>
            <a href="https://www.linkedin.com/in/farrosilman" target="_blank" rel="noreferrer" className="border-b border-black/20 dark:border-white/20 hover:border-blue-500 transition-all pb-2 dark:text-white tracking-widest text-nowrap">LinkedIn</a>
          </div>
        </section>

        {/* FOOTER */}
        <footer className="py-8 md:py-12 border-t border-black/5 dark:border-white/5 px-6">
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-4 max-w-7xl text-left">
            ...
            <div className="text-[8px] md:text-[9px] font-mono text-slate-500 dark:text-slate-300 uppercase tracking-widest text-center">STABILITY & SECURITY DRIVEN</div>
          </div>
        </footer>

        {/* BACK TO TOP BUTTON WITH FULL PROGRESS RING */}
        <button
          onClick={scrollToTop}
          className={`fixed bottom-6 right-6 md:bottom-10 md:right-10 z-[60] flex items-center justify-center w-12 h-12 md:w-15 md:h-15 transition-all duration-700 cubic-bezier(0.16, 1, 0.3, 1) group ${
            showBackToTop ? 'translate-y-0 opacity-100 scale-100' : 'translate-y-10 opacity-0 scale-50 pointer-events-none'
          }`}
        >
          <svg className="absolute inset-0 w-full h-full -rotate-90 transform" viewBox="0 0 100 100">
            <circle cx="50" cy="50" r="45" fill="none" stroke="currentColor" strokeWidth="5" className="text-black/5 dark:text-white/10" />
            <circle 
              cx="50" cy="50" r="45" 
              fill="none" 
              stroke="currentColor" 
          ...
          <div className="relative w-[80%] h-[80%] rounded-full bg-white/20 dark:bg-white/5 backdrop-blur-2xl border border-white/20 dark:border-white/10 flex items-center justify-center shadow-xl group-hover:bg-blue-600/10 transition-colors duration-300">
            <svg viewBox="0 0 24 24" className="w-5 h-5 md:w-6 md:h-6 text-blue-600 dark:text-blue-400 group-hover:-translate-y-1 transition-transform duration-500 ease-out" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
...
const AboutItem = ({ title, place, year, desc, color = "border-black/10 dark:border-white/10" }) => (
  <div className={`group border-l-2 ${color} pl-5 md:pl-6 transition-all`}>
    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-1 gap-1 md:gap-4 text-left">
    ...
    <p className="text-[10px] uppercase font-bold text-slate-500 tracking-widest mb-1 text-left">{place}</p>
    <p className="text-xs md:text-sm text-slate-600 dark:text-slate-400 font-light leading-relaxed max-w-md text-left">{desc}</p>
  </div>
);
...
const SkillBlock = ({ title, skills }) => (
  <div className="text-left">
    ...
    <div className="flex flex-wrap gap-2">
      {skills.map(s => (
        <span key={s} className="px-3 py-1.5 bg-slate-50 dark:bg-white/5 text-slate-600 dark:text-slate-400 text-[10px] font-bold rounded-xl border border-black/5 dark:border-white/10 hover:border-blue-500/40 hover:text-blue-500 transition-all duration-300">
          {s}
        </span>
      ))}
    </div>
      ...
      <div className={`w-full lg:col-span-7 ${index % 2 !== 0 ? 'lg:order-2' : ''}`}>
        <div className="relative group overflow-hidden rounded-2xl md:rounded-[2rem] bg-white dark:bg-[#1a1a1a] border border-black/5 dark:border-white/5 aspect-[16/10] shadow-sm transition-all duration-700">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent z-10 flex flex-col justify-end p-5 md:p-10">
            <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-700 text-left">
